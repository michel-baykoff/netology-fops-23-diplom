...
Первая попытка установки оказалась не успешной из-за отсутствия необходимых зависимостей из ansible galaxy которые по мере необходимости устанавливались командой `ansible-galaxy collection install community.crypto`. 
